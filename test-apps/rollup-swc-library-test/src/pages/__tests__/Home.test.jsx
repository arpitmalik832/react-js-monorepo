...
import {
  ...
  log,
  useBackPress,
} from '@arpitmalik832/react-js-rollup-swc-monorepo-library';
...
jest.mock('@arpitmalik832/react-js-rollup-swc-monorepo-library', () => ({
  __esModule: true,
  ...jest.requireActual('@arpitmalik832/react-js-rollup-swc-monorepo-library'),
  log: jest.fn(),
