...
import {
  ...
  log,
  useBackPress,
} from '@arpitmalik832/react-js-rollup-flow-monorepo-library';
...
jest.mock('@arpitmalik832/react-js-rollup-flow-monorepo-library', () => ({
  __esModule: true,
  ...jest.requireActual('@arpitmalik832/react-js-rollup-flow-monorepo-library'),
  log: jest.fn(),
