...
import {
  ...
  log,
  useBackPress,
} from '@arpitmalik832/react-js-vite-flow-monorepo-library';
...
jest.mock('@arpitmalik832/react-js-vite-flow-monorepo-library', () => ({
  __esModule: true,
  ...jest.requireActual('@arpitmalik832/react-js-vite-flow-monorepo-library'),
  log: jest.fn(),
